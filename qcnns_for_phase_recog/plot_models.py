...
def run_qcnn(num_qubits, unique_name, training_fname, test_fname, model_num):
    ...
    if (model_num == 0):
        ...
        # Original layering configuration:
        ...
        my_qcnn.add_layer(my_qcnn.Layers[legacy_fully_connected_layer.name], kwargs={}) # This needs to stay here.
        ...
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv4_layer"], kwargs={"label": "C4_1"})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C2"})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "test_label"})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C3", "start_index": 1})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C4", "start_index": 2})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_pool_layer"], kwargs={"label": "P1",
                                                                       "update_active_qubits": {"group_len": 3,
        ...
        # Take away one convolutional layer:
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv4_layer"], kwargs={"label": "C4_1"})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C3", "start_index": 1})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C4", "start_index": 2})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_pool_layer"], kwargs={"label": "P1",
        ...
        # Take away two convolutional layers:
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv4_layer"], kwargs={"label": "C4_1"})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_conv_layer"], kwargs={"label": "C4", "start_index": 2})
        my_qcnn.add_layer(my_qcnn.Layers["legacy_pool_layer"], kwargs={"label": "P1",
                                                                       "update_active_qubits": {"group_len": 3,
    ...
    learning_rate = 100000  # intial value was 10 but this quantity doesn't learn fast enough !  CAN ALSO PLAY AROUND WITH THE LEARNING RATE (INITIAL VALUE IS 100000).
...
def main():
    for num_qubits in [9]:
        ...
        unique_name_0 = f"n{num_qubits}_test0/"
        unique_name_1 = f"n{num_qubits}_test1/"
        unique_name_2 = f"n{num_qubits}_test2/"
        unique_name_3 = f"n{num_qubits}_test3/"
